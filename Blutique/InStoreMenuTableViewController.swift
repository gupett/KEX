//
//  InStoreMenuTableViewController.swift
//  Blutique
//
...
class InStoreMenuTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 3{
            ...
            if storeNavController == nil{
                ...
                //self.present(storeNavController!, animated: true, completion: nil)
                storeNavController?.dismiss(animated: true, completion: nil)
...
/*
 ...
 self.present(inStoreController, animated: true, completion: {
